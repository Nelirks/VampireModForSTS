...
public class AwaitInvitation extends AbstractDynamicCard {

    // TEXT DECLARATION

    public static final String ID = DefaultMod.makeID(AwaitInvitation.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
